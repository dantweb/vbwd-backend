...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "ACTIVE", "SUSPENDED", "DELETED", name="userstatus"),
            nullable=False,
        ),
        sa.Column(
            "role", sa.Enum("USER", "ADMIN", "VENDOR", name="userrole"), nullable=False
        ),
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("DRAFT", "ACTIVE", "COMPLETED", "ARCHIVED", name="usercasestatus"),
            nullable=False,
        ),
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_index(
        op.f("ix_user_case_user_id"), "user_case", ["user_id"], unique=False
    )
    op.create_table(
        "user_details",
        sa.Column("user_id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_user_details_user_id"), "user_details", ["user_id"], unique=True
    )
    op.create_table(
        "tarif_plan",
        sa.Column("name", sa.String(length=100), nullable=False),
    ...
    op.create_index(
        op.f("ix_tarif_plan_is_active"), "tarif_plan", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_tarif_plan_price_id"), "tarif_plan", ["price_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_subscription_expires_at"), "subscription", ["expires_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_user_invoice_invoice_number"),
        "user_invoice",
        ["invoice_number"],
        unique=True,
    )
    op.create_index(
        op.f("ix_user_invoice_status"), "user_invoice", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_user_invoice_user_id"), "user_invoice", ["user_id"], unique=False
    )
