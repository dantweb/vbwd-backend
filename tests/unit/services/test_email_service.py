...
<html><body>{% block content %}{% endblock %}</body></html>""")
        ...
        welcome_html.write_text("""{% extends "base.html" %}
...
class TestEmailServiceConvenienceMethods:
    ...
    def email_service(self, tmp_path):
        ...
        for name in ["welcome", "subscription_activated", "subscription_cancelled",
                     "payment_receipt", "payment_failed", "invoice", "renewal_reminder"]:
