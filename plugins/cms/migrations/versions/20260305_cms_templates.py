...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "widget_id",
            UUID(as_uuid=True),
            sa.ForeignKey("cms_widget.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "parent_id",
            UUID(as_uuid=True),
            sa.ForeignKey("cms_menu_item.id", ondelete="CASCADE"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "layout_id",
            UUID(as_uuid=True),
            sa.ForeignKey("cms_layout.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "widget_id",
    ...
    op.create_index(
        "ix_cms_layout_widget_layout_id", "cms_layout_widget", ["layout_id"]
    )
    op.create_index(
        "ix_cms_layout_widget_widget_id", "cms_layout_widget", ["widget_id"]
    )
